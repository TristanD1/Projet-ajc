		...
		<%@ page pageEncoding="UTF-8" %>
			...
			<body>
				...
				<form method="POST">
					...
					<div class="row">
						<div class="col-2 col-form-label">
							<label for="etat" class="form-label">Etat de l'aventurier :</label>
						</div>

						<div class="col-10">
							<input class="form-control" type="text" id="etat" name="etat"
								value="${ aventurier.getEtat() }" />
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-1">
							<label class="form-label">Recruté :</label>
						</div>

						<div class="col-2">
							<div class="form-check">
								<c:if test="${ aventurier.isRecru() }">
									<input class="form-check-input" type="checkbox" value="true" name="isRecru"
					...
					<div>
						...
						<c:if test="${ aventurier != null }">
							...
							<a href="ajouter-aventurier" type="button">Annuler</a>
						</c:if>
					</div>
				</form>
