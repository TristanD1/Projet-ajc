					...
					<tbody>
						<c:forEach items="${ quetes }" var="quete">
							<tr>
								...
								<td>${ quete.etat }</td>
								<td><input type="image" src="assets/img/livre.svg" data-bs-toggle="offcanvas"
										data-bs-target="#offcanvasRight-${ quete.id }" aria-controls="offcanvasRight"
										id="btn-details"></td>
						...
						<div class="modal-dialog modal-lg">
							<div class="modal-content">
								...
								<div class="modal-footer">
									...
									<button href="quete" type="button" class="btn btn-secondary" data-bs-dismiss="modal"
